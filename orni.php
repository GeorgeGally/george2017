...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>George Gally - Crumpler</title>
...
<body>
	...
	<div class="container">
		...
		<div class="one-third column">
			<h5>Ornithology</h5>
			<p>
			Product brochure magazine for Crumpler's range of Camera bags.</p>
		</div>
		...
		<div class="two-thirds column">
			<br><hr> <br>
			<img src="images/internetisgood.jpg" width="290" style="float:left; border: 8px #fff solid; margin-right: 10px; margin-bottom: 10px;">
