...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>George Gally - Resume</title>
...
<body style="background: #fafafa">
	...
	<div class="container">
		...
		<div class="sixteen columns add-bottom">
			...
			<h1 class="remove-bottom" style="margin-top: 40px">Resume</h1>
			<h5>Award winning Creative Director, designer, creative technologist. </h5>
...
<div class="add-top  add-bottom  one-third column">
 Most recently I held the positions of Creative Director at TBWA/HK, Director of Innovation at Quirk Agency, Johannesburg, participated in a Google startup incubator programme in Cape Town, exhibited as an artist in Berlin and Milan and worked as Associate CD at Ogilvy &amp; Mather in Tokyo. <br><br>
 I enjoy experimenting with emerging or dying technologies, and am comfortable working in pretty much any medium, but mostly excited by technology and how this crosses over with real world analogue interactions.<br><br>
</div>
...
<div class="sixteen columns add-bottom">
 ...
 <br> <br> <br>
  ...
  <div class="two-thirds column">
    Working on various above the line, innovation and digital projects.
    Creatively led pitch to win NBA business. <br>
    Creatively led ptich to retain Standard Chartered Bank business. <br>


    <br>
    <br>
      Clients include NBA, Standard Chartered Bank, MasterCard, McDonalds.
    <br><br>
    <hr>
  </div>
  ...
  <div class="two-thirds column">
    ...
    Leading Innovation at Quirk, one of the most important digital agencies in South Africa, I spend most of my time conceptualising and building innovative prototypes, as well as consulting and pushing an agenda of innovation and driving change.<br><br>
  ...
  <div class="two-thirds column">
    ...
    Chosen out of 100s of applicants to participate in the Umbono Accelerator Programme <br>
Co-founded, designed and programmed events listings startup Gigham, helping you find things to do based on your social profile and location. <br>
Gigham grew out of another startup project I was developing while in Berlin - Walaa - a music search engine. <br>
Launched in 6 cities - Johannesburg, Cape Town, Durban, Port Elizabeth, Bloemfontein and Nairobi. <br>
...
<br>
  ...
  <div class="two-thirds column ">
    It had always been a dream of mine to live in Berlin, where I spent my time furthering my experiments in light, and sound and motion reactive systems. <br>
Invited to exhibit at Salone Internazionale del Mobile. <br>
...
Built startup, music search engine Walaa, which eventually pivoted to become Gigham.
  ...
  <div class="two-thirds column ">
    Mandated to serve as a bridge between ATL and Digital, though ended up working mainly on above the line projects. <br>
Creative Director on the Jetstar Account, successfully launching the brand into the Tokyo market <br>
Helped grow Jetstar business in Osaka and Nogoya by 400% in a year. <br>
Jetstar team award as the best 360 Account at Ogilvy in Asia. <br>
...
Sokenbicha ads repeatedly scored the highest link test scores in the brand's history.
  ...
  <div class="two-thirds column">
    ...
    Built agency from the ground up. <br>
Within a year of launch, rose to becoming one of the top 10 agencies in South Africa - and the only digital agency on the list.
Leading the creative team at Radarboy we won a host of awards, with me becoming the most awarded new media creative in South Africa. <br>
...
<div class="small-top">Cape Town, South Africa, 1997-1999</div><br><br>
<br><br>
  </div>
  ...
  <div class="two-thirds column">
   ...
   <div class="one-third column">
       <h4>Certificate in Design and Multimedia</h4>
    </div>
...
Concept Interactive database programming course <br>
FlashForward,
  New York: 2001 <br>
...
<br>
Coding Languages: <br>
PHP, Javascript, Java/Processing, Actionscript, Ruby.
