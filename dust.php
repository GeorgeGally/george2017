...
<body>
	...
	<div class="container">
		<div class="sixteen columns">
			<h1 class="remove-bottom" style="margin-top: 40px">Motion Dust</h1>
			<h5>Reactive Video Installation</h5>

			Creative Direction, Concept, programming<br>
			Processing <br>
			<hr />
		</div>
...
Move slider to adjust number of particles. <br>
Press 'm' for mirror effect <br>
Press 'd' to show where the movement is calculated <br>
